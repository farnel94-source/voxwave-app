...
class TestFreeTierLocalNotBlocked:
    ...
    def test_local_transcription_allowed_after_daily_limit(self, mock_dev):
    ...
    def test_cloud_allowed_under_limit(self, mock_dev):
    ...
    def test_licensed_user_always_allowed(self, mock_dev):
